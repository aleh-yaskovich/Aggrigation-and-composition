...
public class Main {
	...
	public static void main(String[] args) {
		...
		// Создаем заголовок и текст
		TextLogic logic = new TextLogic();
		List<Sentence> listText = text.getText();
		String[] createText = logic.createText(listText);
		String[] createTitle = logic.createTitle(text.getTitle());
		
		// Выводим заголовок и текст
		TextView view = new TextView();
		view.textView(createTitle);
		view.textView(createText);
